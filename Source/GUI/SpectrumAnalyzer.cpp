...
{
    //this is static creation of gains values. 
    /*return std::vector<float>
    {
        -24, -12, 0, 12, 24
    };*/
...
void SpectrumAnalyzer::drawTextLabels(juce::Graphics& g, juce::Rectangle<int> bounds)
{
    ...
    for (auto gDb : gain)
    {
       ...
       // str.clear();
        //This line shifts the values of the scale
        //str << (gDb - 24.f);
...
void SpectrumAnalyzer::resized()
{
    ...
    auto negInf = jmap(bounds.toFloat().getBottom(), fftBounds.getBottom(), fftBounds.getY(), NEGATIVE_INFINITY, MAX_DECIBELS); // -48.f, 0.f);
